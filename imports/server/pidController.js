...
/**
 * This taken from https://github.com/Philmod/node-pid-controller/blob/master/lib/index.js
 *
 * I couldn't get the npm project to work properly with meteorjs v 1.3.4.1 - was causing compile errors.
 *
 * For now just putting it here directly and hacking it to directly export an es6 class
 *
 */
